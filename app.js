/* ============================================================
   GPT Chatbot - Main Application Logic
   ============================================================
   ลอจิกหลักของแอปพลิเคชันแชทบอท AI
   เชื่อมต่อกับ OpenRouter API เพื่อใช้โมเดล GPT-5.2
   ============================================================ */

// --- ค่าคงที่สำหรับการตั้งค่า (Configuration Constants) ---
const API_BASE_URL = "https://openrouter.ai/api/v1";
const API_KEY = "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";
...
// ============================================================
// API Communication (การสื่อสารกับ API)
// ============================================================

/**
 * ส่งข้อความไปยัง OpenRouter API แบบ Streaming
